                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Row(
                                        children: [
                                          Text("Jhon doe ",style: GoogleFonts.poppins(fontSize: 13.sp,fontWeight: FontWeight.w500),),
                                          Text("1m",style: GoogleFonts.poppins(fontWeight: FontWeight.w400,color: Colors.grey,fontSize: 12.sp),),
                                        ],
                                      ),
                                      Text("Lorem ipsum dolor sit amet  adipiscing elit. ",maxLines: 2,textAlign: TextAlign.justify,style: GoogleFonts.poppins(fontSize: 11 .sp),),

                                      SizedBox(height: 3,),
                                      Row(children: [
                                        Icon(Icons.favorite_border,size: 14,),
                                        Text(" Reply",style: GoogleFonts.poppins(fontSize: 10.sp),),
                                      ],)
                                    ],
                                  ),
                                ),
