          ...
          Container(
            ...
            child: Align(
                ...
                child: Container(
                    ...
                    child: Text("Lorem ipsum is a placeholder text commonly. ",maxLines: 7,style:  GoogleFonts.poppins(color: Colors.black,fontSize: 17.sp,fontWeight: FontWeight.w400),))),
          ),
          Positioned.fill(
            bottom: -74,
            child: Align(
